      ...
      <div class="">
        <div class="page-title">
          <div class="title_left">
            <h3>快递员信息
              <small><a href="/os/manage/deliver/list"><i class="fa fa-angle-double-right"></i> 返回列表 <i
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                <p></p>
                <form id="form_info" class="form-horizontal form-label-left" novalidate action="/os/manage/deliver/add"
                      method="post">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="number" class="hidden" name="dQuyu" id="dQuyu" value="1"/>
                      <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default active">
                          <input type="radio" name="quyu" id="quyu_option1" value="1" onchange='setValue("dQuyu", 1)'>
                          东区
                        </label>
                        <label class="btn btn-default">
                          <input type="radio" name="quyu" id="quyu_option2" value="2" onchange='setValue("dQuyu", 2)'>
                          西区
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="number" id="dAccountState" name="dAccountState" class="hidden" value="0"/>
                      <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default active">
                          <input type="radio" name="state" id="state_option1" value="0"
                                 onchange='setValue("dAccountState", 0)'> 上岗
                        </label>
                        <label class="btn btn-default">
                          <input type="radio" name="state" id="state_option2" value="1"
                                 onchange='setValue("dAccountState", 1)'> 注销
                        </label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-md-offset-3">
                      <button id="submit_info" type="submit" class="btn btn-success">新增</button>
                    </div>
                  </div>
                </form>
              </div>
